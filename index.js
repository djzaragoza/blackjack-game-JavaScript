...
function endGame () {
  if (player.score === 21) {
    document.getElementById('message-board').innerHTML =
      'You win! You got blackjack.' + '<br>' + 'click New Game to play again'
    bet('win')
    document.getElementById('player-money').innerHTML =
      'Your money: $' + player.money
    resetGame()
  ...
  if (dealer.score >= 17 && player.score > dealer.score && player.score < 21) {
    document.getElementById('message-board').innerHTML =
      'You win! You beat the dealer.' + '<br>' + 'click New Game to play again'
    bet('win')
    document.getElementById('player-money').innerHTML =
      'Your money: $' + player.money
    resetGame()
...
function hit () {
  ...
  document.getElementById('player-cards').innerHTML =
    'Player Cards: ' + JSON.stringify(player.cards)
